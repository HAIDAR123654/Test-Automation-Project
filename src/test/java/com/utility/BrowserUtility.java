...
//		WebElement element = driver.get().findElement(locator);
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(locator));//--synchronized method
		logger.info("Element found and now entered Text " + textToEnter);
	...
	public void enterSpecialKey(By locator, Keys keyToEnter) {
		...
		//WebElement element = driver.get().findElement(locator);
		WebElement element = wait.until(ExpectedConditions.visibilityOfElementLocated(locator));//--synchronized method
		logger.info("Element found and now entered Special Key " + keyToEnter);
